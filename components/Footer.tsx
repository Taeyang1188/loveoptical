      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.instagram.com/loveoptical/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#A53837] transition-colors"
              >
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0 items-center">
            ...
            <a 
              href="https://litt.ly/loveoptical" 
              target="_blank" 
              rel="noopener noreferrer"
