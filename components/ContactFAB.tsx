...
const ContactFAB: React.FC = () => {
  return (
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col space-y-4">
      ...
      <button className="bg-white w-14 h-14 rounded-full flex items-center justify-center text-[#A53837] shadow-2xl hover:scale-110 transition-transform group border border-gray-100">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
